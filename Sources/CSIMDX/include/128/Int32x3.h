...
#define RETURN_RESULT(value) { Int32x3 result; result.intrinsic = value; return result; }
...
#else
    Int32 values[] = { element0, element1, element2 };
    return CXInt32x3MakeLoad(values);
#endif
}
...
#else
    return CXInt32x3Make(value, value);
#endif
}

/// Returns an intrinsic type with all elements initialized to zero (0).
/// @return `(Int32x3){ 0, 0, ... }`
CX_INLINE Int32x3 CXInt32x3MakeZero(void) {
#if CX_X86_ARCH >= CX_X86_LEVEL_SSE2
